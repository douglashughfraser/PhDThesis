...
ltl reachable_state {
	!<>(
		Flood_Gate_Valve == REACHABLE_Flood_Gate_Valve &&
		Flood_Pump == REACHABLE_Flood_Pump &&
		Sump_Valve == REACHABLE_Sump_Valve &&
		Sump_Pump_1 == REACHABLE_Sump_Pump_1 &&
		Sump_Pump_2 == REACHABLE_Sump_Pump_2 &&
		Return_Water_Supply_Control == REACHABLE_Return_Water_Supply_Control &&
		HMI_Return_Feed == REACHABLE_HMI_Return_Feed &&
		Gen_A_Status == REACHABLE_Gen_A_Status &&
		Gen_A_Active == REACHABLE_Gen_A_Active &&
		Gen_A_Fan == REACHABLE_Gen_A_Fan &&
		Gen_A_GreenLED == REACHABLE_Gen_A_GreenLED &&
		Gen_A_RedLED == REACHABLE_Gen_A_RedLED &&
		Gen_A_Pump == REACHABLE_Gen_A_Pump &&
		Gen_A_Valve == REACHABLE_Gen_A_Valve &&
		Gen_B_Status == REACHABLE_Gen_B_Status &&
		Gen_B_Active == REACHABLE_Gen_B_Active &&
		Gen_B_Fan == REACHABLE_Gen_B_Fan &&
		Gen_B_GreenLED == REACHABLE_Gen_B_GreenLED &&
		Gen_B_RedLED == REACHABLE_Gen_B_RedLED &&
		Gen_B_Pump == REACHABLE_Gen_B_Pump &&
		Gen_B_Valve == REACHABLE_Gen_B_Valve &&
		Tag_2 == REACHABLE_Tag_2
	)
}
